...
namespace LahoreGarrisonUniversity.Controllers
{
    public class FrontEndCoursesController : BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Flag,Semester,Duration,CreditHourTheory,CreditHourPractical,Level,StudentLevel,Description,CourseStructure,ImageUrl,RecommendedBooks,PrerequsiteCourse")] FrontEndCourse frontEndCourse)
        {
            if (ModelState.IsValid)
            {
