...
{
    public class AssignCourseController : BaseController
    {
        ...
        public ActionResult LoadTeacher(int? departmentId)
        {
            ...
            return PartialView("~/Views/Shared/Common/_FilteredTeacher.cshtml");
        }
        ...
        public ActionResult LoadCourse(int? departmentId)
        {
            ...
            return PartialView("~/Views/shared/Common/_FilteredCourse.cshtml");
        ...
        public PartialViewResult TeacherInfoLoad(int? teacherId)
        {
            if (teacherId != null)
            {
                ...
                return PartialView("~/Views/Shared/Common/_TeachersCreditInfo.cshtml");
            }
            else
            {
                return PartialView("~/Views/Shared/Common/_TeachersCreditInfo.cshtml");
        ...
        public PartialViewResult CourseInfoLoad(int? courseId)
        {
            if (courseId != null)
            {
                ...
                return PartialView("~/Views/Shared/Common/_CourseInfo.cshtml");
            }
            else
            {
                return PartialView("~/Views/Shared/Common/_CourseInfo.cshtml");
        ...
        public PartialViewResult CourseStatusLoad(int? departmentId)
        {
            ...
            return PartialView("~/Views/shared/Common/_coursestatus.cshtml", courseList);
        }
